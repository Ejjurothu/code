...
import { QueueResponseModel } from "../queue";

@Exclude()
export class WaitTimeAttractionsGetResponseModel {
    /**
     * The unique identifier for the wait time attraction.
     * example uor-transformers-the-ride-3d
     */
    @Expose()
    public wait_time_attraction_id: string;
     ...
     */
    @Expose()
    public queues?: QueueResponseModel[];
}
